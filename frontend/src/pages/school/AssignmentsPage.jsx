...
export default function AssignmentsPage() {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      const created = await assignmentService.createAssignment(newAsn);
      ...
      success(
        `Assignment "${
          created.assignment?.title || created.title
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Create homework tasks, monitor submissions and review grading across
            classes
          </p>
        </div>
        ...
        <form onSubmit={handleAddSubmit}>
          ...
          <Select
            ...
            options={[
              ...
              ...(
                classes.find((schoolClass) => schoolClass.name === newAsn.class)
                  ?.sections || []
              ).map((section) => ({
                value: section,

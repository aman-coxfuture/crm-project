        ...
        items: [
          {
            ...
            children: [
              {
                label: "Fee Dashboard",
                path: "/school-admin/fees?tab=dashboard",
                tabKey: "dashboard",
              },
              {
                label: "Student Fees",
                path: "/school-admin/fees?tab=students",
                tabKey: "students",
              },
              {
                label: "Fee Collection",
                path: "/school-admin/fees?tab=collection",
                tabKey: "collection",
              },
              {
                label: "Pending Fees",
                path: "/school-admin/fees?tab=pending",
                tabKey: "pending",
              },
              {
                label: "Overdue Fees",
                path: "/school-admin/fees?tab=overdue",
                tabKey: "overdue",
              },
              {
                label: "Late Fine",
                path: "/school-admin/fees?tab=late-fine",
                tabKey: "late-fine",
              },
              {
                label: "Payment History",
                path: "/school-admin/fees?tab=history",
                tabKey: "history",
              },
              {
                label: "Fee Reports",
                path: "/school-admin/fees?tab=reports",
                tabKey: "reports",
              },
            ],
          },
          {
            ...
            children: [
              {
                label: "Staff Fee Dashboard",
                path: "/school-admin/staff-fees?tab=dashboard",
                tabKey: "dashboard",
              },
              {
                label: "All Employees",
                path: "/school-admin/staff-fees?tab=all",
                tabKey: "all",
              },
              {
                label: "Pending Payments",
                path: "/school-admin/staff-fees?tab=pending",
                tabKey: "pending",
              },
              {
                label: "Paid Payments",
                path: "/school-admin/staff-fees?tab=paid",
                tabKey: "paid",
              },
              {
                label: "Payment History",
                path: "/school-admin/staff-fees?tab=history",
                tabKey: "history",
              },
              {
                label: "Salary Payments",
                path: "/school-admin/staff-fees?tab=salary",
                tabKey: "salary",
              },
              {
                label: "Payment Reports",
                path: "/school-admin/staff-fees?tab=reports",
                tabKey: "reports",
              },
            ],
          },
            ...
            {!isCollapsed && (
              <div style={{ overflow: "hidden" }}>
                ...
                >
                  {role === "super-admin"
                    ? "Super Admin CRM"
                    : selectedSchool?.name?.split(" ")[0] + " School" ||
                      "School CRM"}
                </div>
                <div
                  style={{
              ...
              >
                {section.items.map((item) => {
                  ...
                  const isExpanded = Boolean(
                    expandedMenus[item.id || item.label],
                  );
                        ...
                        {isExpanded && (
                          ...
                          >
                            {item.children.map((sub) => {
                              ...
                              const currentTab =
                                currentSearch.get("tab") || "dashboard";
                              const isSubActive =
                                isParentActive && currentTab === sub.tabKey;
                              ...
                              return (
                                <NavLink
                                  ...
                                  style={{
                                    ...
                                    color: isSubActive
                                      ? "var(--primary)"
                                      : "var(--sidebar-sub-text, var(--sidebar-text))",
